...
**pathogenseq** is a pathogen whole genome sequence (WGS) data analysis pipline, which inclues sequence quality checking, quality control, taxonomy assignment, assembly, assembly quality assessment, assembled contigs annotation, mlst, antimicrobial resistance, virulome, plasmid, and taxonomy prediciton.
